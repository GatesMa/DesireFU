...
public class Normalaccount_ extends TableImpl<Normalaccount_Record> {
    ...
    private static final long serialVersionUID = -685002731;
    ...
    /**
     * The column <code>DFU_.NormalAccount_.realName</code>. 真实姓名
     */
    public final TableField<Normalaccount_Record, String> REALNAME = createField("realName", org.jooq.impl.SQLDataType.VARCHAR(255), this, "真实姓名");
    ...
    private Normalaccount_(Name alias, Table<Normalaccount_Record> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, "普通学生账号");
    }
