...
public class RetCodeUtils {
    ...
    public static boolean isOk(ReturnCode retCode) {
        return retCode != null && retCode.getCode() != null && retCode.getCode() == ApiReturnCode.OK.code();
    }
    ...
    public static boolean isResourceNotFound(ReturnCode retCode) {
        return null != retCode && null != retCode.getCode() && retCode.getCode() == ApiReturnCode.RESOURCE_NOT_FOUND.code();
    }
